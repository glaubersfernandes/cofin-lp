...
export default function LandingPage() {
  ...
  const APP_DOMAIN = "https://cofin.vercel.app";
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 px-4">
          ...
          <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative lg:ml-auto max-w-2xl perspective-1000">
      ...
      <footer className="bg-slate-950 py-12 text-slate-400 text-sm">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a href={`${APP_DOMAIN}/terms`} className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
              Termos de Uso
            </a>
            <a href={`${APP_DOMAIN}/privacy`} className="hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
              Privacidade
            </a>
          </div>
